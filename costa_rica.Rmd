---
title: "R Notebook"
output: Fiscal policy and economic growth
---
...
```{r}
raw_data <- read.csv("C:/Users/benny/OneDrive/Documents/Teaching/Data and codes/Time series/costa_rica.csv", header=TRUE, sep=";")
```
...
data_pivot <- raw_data%>% pivot_longer( !c(Year, GDP), names_to ="Economic_variables", values_to = "Value")
ggplot(data_pivot,aes(Year,Value))+ geom_line()+facet_wrap("Economic_variables",scales = "free")
